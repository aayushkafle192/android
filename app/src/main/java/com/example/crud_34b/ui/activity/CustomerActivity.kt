...
import com.example.crud_34b.repository.CustomerRepositoryImpl
import com.example.crud_34b.repository.UserRepoImpl
import com.example.crud_34b.viewmodel.CustomerViewModel
...
class CustomerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        customerViewModel  = CustomerViewModel(repo)



        var data = UserModel("","aaa")
        customerViewModel.addUser(data){
                success, message ->
            if(success){
